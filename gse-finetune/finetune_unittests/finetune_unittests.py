...
class TestFineTune(unittest.TestCase):
    ...
    def test_model_metrics(self):
        ...
        self.assertAlmostEqual(self.result_csv["   metrics/precision"].iloc[0], self.config["ref_precision"])
        self.assertAlmostEqual(self.result_csv["      metrics/recall"].iloc[0], self.config["ref_recall"])
        self.assertAlmostEqual(self.result_csv["     metrics/mAP_0.5"].iloc[0], self.config["ref_map_0.5"])
        self.assertAlmostEqual(self.result_csv["metrics/mAP_0.5:0.95"].iloc[0], self.config["ref_map_0.5_0.95"])
